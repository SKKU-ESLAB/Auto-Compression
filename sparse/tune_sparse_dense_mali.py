...
def apply_func(search_policy, state, stage_id):
    ...
    if ARGS.output_layout == 'hwc':
        ...
        #jo, ji = s0.split(sparse_dense_block, j, [4])
        #no, ni = s0.follow_split(consumer, n, len(s0.transform_steps) - 1, 1)

        c0, c1, c2 = s0.split(sparse_dense_block, c, [None, None])

        #s0.reorder(sparse_dense_block, [i0, j0, i1, j1, i2, j2, c0, row_offset, c1, i3, c2, i4, jo, ji])
        #s0.reorder(consumer, [m0, n0, m1, n1, m2, n2, m3, no, ni])
        ...
        #s0.reorder(sparse_dense_block, [j0, i0, j1, i1, j2, i2, c0, row_offset, c1, i3, c2, jo, ji, i4])
        #s0.reorder(consumer, [n0, m0, n1, m1, n2, m2, no, ni, m3])
