...
void depthwise_kernel1x1_stride1_inplace_kernel_CHW(
...
tinyengine_status depthwise_kernel1x1_stride1_inplace_CHW(q7_t *input, const uint16_t input_x, const uint16_t input_y,
                ...
                const uint16_t output_ch, q15_t *runtime_buf, q7_t pad_value)
{
    ...
    for (c = 0; c < input_ch; c++){
        ...
        depthwise_kernel1x1_stride1_inplace_kernel_CHW(output_y, output_x, bias++, biasR++, ksrc, output_mult++, output_shift++, inplace_out,output_offset,output_activation_min, output_activation_max,cols_8b_start, input_x, input_ch);
        ksrc += 1;
        input++;
    }
