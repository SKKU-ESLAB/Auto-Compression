...
#define ch_mask ((uint64_t)(1 << LogBase2(ch_width)) - 1)
#define ba_mask ((uint64_t)(1 << LogBase2(ba_width)) - 1)
#define bg_mask ((uint64_t)(1 << LogBase2(bg_width)) - 1)
#define co_mask ((uint64_t)(1 << LogBase2(co_width)) - 1)
#define ra_mask ((uint64_t)(1 << LogBase2(ra_width)) - 1)
#define ro_mask ((uint64_t)(1 << LogBase2(ro_width)) - 1)
