...
CONFIG_SUPERNET = {
    ...
    'train_settings' : {
        'cnt_epochs' : 1, # 90
        'train_thetas_from_the_epoch' : 60,
        'print_freq' : 50,
        'path_to_save_model' : '/home/khs/data/sup_logs/best_model.pth',
        'path_to_save_model_high' : '/home/khs/data/sup_logs/best_model_high.pth',
        # for Gumbel Softmax
