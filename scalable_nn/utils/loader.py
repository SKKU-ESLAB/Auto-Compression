...
def app():
    ...
    if FLAGS is None:
        ...
        if FLAGS.DENSE_TEACHER:
            FLAGS.log_dir = f"{FLAGS.model}_DH{FLAGS.DL}_DL{FLAGS.DH}_W{FLAGS.width_mult}_{FLAGS.pruner}_{FLAGS.BS_R}x{FLAGS.BS_C}_T"
        else:
            FLAGS.log_dir = f"{FLAGS.model}_DH{FLAGS.DL}_DL{FLAGS.DH}_W{FLAGS.width_mult}_{FLAGS.pruner}_{FLAGS.BS_R}x{FLAGS.BS_C}"
