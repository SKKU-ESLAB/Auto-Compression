...
parser.add_argument("--save_folder", type=str, default='./demo/tflite', help='path to saving result folder')
...
tflite_path = "/home/sangjun/octyolo/yolov3-pytorch/"+str(args.alpha)+".tflite"
...
for paths, images in tqdm.tqdm(dataloader, desc='Batch'):
    with torch.no_grad():
        ...
        prediction = utils.utils.non_max_suppression(output_data, args.conf_thres, args.nms_thres)
