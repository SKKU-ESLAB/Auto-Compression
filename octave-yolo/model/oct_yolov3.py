...
class OCTYOLOv3(nn.Module):
    def __init__(self, image_size: int, num_classes: int):
        super(OCTYOLOv3, self).__init__()
        ...
        self.conv_block3 = self.make_octconv_block(1024, 512)
        ...
        self.conv_block2 = self.make_octconv_block(768, 256)
        ...
        self.conv_block1 = self.make_octconv_block(384, 128)
    ...
    def forward(self, x, targets=None):
        ...
        conv_block2, _conv_block2 = self.conv_block2(scale2)
        ...
        conv_block1, _conv_block1 = self.conv_block1(scale1)
    ...
    def make_octconv_block(self, in_channels: int, out_channels: int):
        double_channels = out_channels * 2
        modules = nn.Sequential(
